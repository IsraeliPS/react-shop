...
import Card from './CardDetalle/CardDetalle'

const CardDetalle = 'https://api-cafe-tamales.herokuapp.com/api/Productos/:id'

const Detalle = ({ addToCart, cartItems, removeFromCart }) => {
